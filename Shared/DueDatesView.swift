...
struct NewDueDateView: View {
	...
	struct DueDateSelectionView: View {
		...
		private struct DueDatesListView: View {
			...
			let project: Project
			@FetchRequest(entity: DueDate.entity(), sortDescriptors: [NSSortDescriptor(keyPath: \DueDate.date, ascending: true)], predicate: NSPredicate(format: "date > %@", NSDate(timeIntervalSinceNow: -86400))) var dueDates: FetchedResults<DueDate>
